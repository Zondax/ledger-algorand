...
static parser_error_t _readScope(parser_context_t *c, parser_arbitrary_data_t *v);
static parser_error_t _readEncoding(parser_context_t *c, parser_arbitrary_data_t *v);
...
parser_error_t _read_arbitrary_data(parser_context_t *c, parser_arbitrary_data_t *v)
{
    ...
    CHECK_ERROR(_readScope(c, v))
    CHECK_ERROR(_readEncoding(c, v))
...
static parser_error_t _readSigner(parser_context_t *c, parser_arbitrary_data_t *v)
{
    uint32_t signerLen = PK_LEN_25519;
